  ...
  while (fgets(line, kMaxLineLength, file)) {
    ...
    if (sscanf(line, " material %s", name) == 1) {
      ...
      while (fgets(line, kMaxLineLength, file)) {
        ...
        sscanf(line, " color %f %f %f", &material.albedo.x, &material.albedo.y,
               &material.albedo.z);
        ...
        sscanf(line, " extinction %f %f %f", &material.extinction.x,
               &material.extinction.y, &material.extinction.z);
    ...
    if (strstr(line, "Renderer")) {
      ...
      while (fgets(line, kMaxLineLength, file)) {
        ...
        sscanf(line, " resolution %d %d", &renderOptions.resolution.x,
    ...
    if (strstr(line, "mesh")) {
      ...
      while (fgets(line, kMaxLineLength, file)) {
        ...
        sscanf(line, " position %f %f %f", &xform[3][0], &xform[3][1],
               &xform[3][2]);
        sscanf(line, " scale %f %f %f", &xform[0][0], &xform[1][1],
               &xform[2][2]);
      }
      if (!filename.empty()) {
